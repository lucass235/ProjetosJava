package insercaodenum2;

import java.util.Scanner;

public class InsercaoDeNum2 {
    ...
    public static void main(String[] args) {
        ...
        int valor, posicaoA = 0, posicaoB = 0, indi, opcao;
        do {
            ...
            switch (opcao) {
                ...
                case 2: // procurar número.
                    ...
                    if (valor % 2 == 0) { // busca no vetor de pares.
                        indi = buscaValor(A, posicaoA, valor);
                    } else { // busca no vetor de ímpres.
                        indi = buscaValor(B, posicaoB, valor);
                    }
                    System.out.println("O índice do valor " + valor
                            + " encontrado foi o : [" + indi + "]");
                    break;
    ...
    public static int posicaoVet(int[] vet, int posicao, int valor) {
        int vazio;
        vazio = buscaValor(vet, posicao, valor);
    ...
    public static int buscaValor(int[] vet, int pos, int valor) {
        ...
        for (int i = 0; i < pos; i++) {
            if (vet[i] == valor) {
                indice = i; // informa o indice do valor encontrado.
            }
        }
        return indice;
    }
